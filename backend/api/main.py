...
MCP_TOOLS = [
    ...
    {"name": "memory_extract", "description": "Auto-extract structured facts (subject→predicate→object triples) from free-form text. Understands Japanese business context and keigo hierarchy.", "inputSchema": {"type": "object", "properties": {"text": {"type": "string"}, "store": {"type": "boolean"}}, "required": ["text"]}, "annotations": READ_ONLY},
    ...
    {"name": "foreign_entry_check", "description": "Foreign market entry guides for Japan: company incorporation (KK/GK), management visa requirements, bank account opening, property search and real estate contracts, and tax registration procedures.", "inputSchema": {"type": "object", "properties": {"query": {"type": "string"}}, "required": ["query"]}, "annotations": READ_ONLY},
    {"name": "foreign_entry_list", "description": "List all 5 foreign entry categories with step counts and estimated timelines for each process.", "inputSchema": {"type": "object", "properties": {}}, "annotations": READ_ONLY},
