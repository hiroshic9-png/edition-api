...
ORGANIZATION_DB = {
    "corporate_hierarchy": {
        ...
        "experience_tips": [
            "課長に『部長にもぜひお話ししたいのですが』と伝えると、課長は『自分が橋渡し役になれる』と感じて積極的に動いてくれる。飛び越えではなく経由で信頼を得る",
            "相手の役職に合わせた話し方を変えると印象が変わる。部長には戦略的な話、課長には実務的な話。『この人は分かっている』と思われる",
        ],
    },
    ...
    "keiretsu": {
        ...
        "experience_tips": [
            "系列企業に営業する際『御社グループの○○とも取引がございます』と言えると、一気に信頼度が上がる。系列内の実績は最強の紹介状",
            "『組織の三菱、人の三井、結束の住友』を知っていると、相手グループに合わせたコミュニケーションができる。三菱には組織的な提案、三井には個人の裁量を尊重した提案が響く",
        ],
    },
    ...
    "payment_practices": {
        ...
        "experience_tips": [
            "支払い条件の交渉は契約前に行う。一度決まった条件を後から変えようとすると信頼を失う。『最初にきちんと話し合える人』が日本では信頼される",
            "請求書を期日より早く送ると『段取りが良い会社だ』と評価される。逆に遅いと経理部門から『あの会社は管理が甘い』という印象を持たれる",
        ],
    },
    ...
    "contract_customs": {
        ...
        "experience_tips": [
            "契約書に固執すると『この人は信頼していないのか』と思われる。逆に『契約書はお互いを守るものです』と伝えると、日本人も安心して応じる",
            "印鑑の押し方が丁寧だと『この会社はしっかりしている』と見られる。斜めに押す、欠けている印鑑を使う等は信頼を損なう。所作がメッセージ",
        ],
    },
    ...
    "industry_associations": {
        ...
        "experience_tips": [
            "業界団体の懇親会に参加すると、普段会えない経営者と直接話せる。名刺交換の場として最も効率が良い。懇親会の『二次会』に残ると本音の情報交換ができる",
            "業界団体の委員会に手を挙げて参加すると、業界の意思決定プロセスに入れる。『この人は業界に貢献しようとしている』と認められると、ビジネスの紹介が自然に増える",
        ],
    },
}
