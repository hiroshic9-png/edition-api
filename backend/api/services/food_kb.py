...
FOOD_DB = {
    ...
    "cuisine_types": {
        ...
        "everyday_food": {
            "types": [
                ...
                "おにぎり: コンビニの定番(¥120〜¥250)。鮭、梅、ツナマヨが三大定番",
            ],
        },
    ...
    "dietary_restrictions": {
        "_meta": {
            ...
            "source": "消費者庁 食品表示法、農林水産省",
            "source_url": "https://www.caa.go.jp/policies/policy/food_labeling/",
            "confidence": "verified",
            "valid_until": None,
            "version": "1.0.1",
            "changelog": ["2026-05-10: Initial verified entry", "2026-05-11: アレルギー表示義務8品目に修正（くるみ2025年義務化）", "2026-05-11: 9品目に更新（カシューナッツ2026年4月追加）"]
        },
        "name_ja": "アレルギー・食制限",
        ...
        "allergy_labeling": {
            "mandatory_9": "表示義務9品目: 卵、乳、小麦、そば、落花生、えび、かに、くるみ（2025年義務化）、カシューナッツ（2026年4月義務化、経過措置2028年3月末まで）",
            "recommended_20": "表示推奨20品目: アーモンド、あわび、いか、いくら、オレンジ、キウイ、牛肉、ごま、さけ、さば、大豆、鶏肉、バナナ、豚肉、ピスタチオ（2026年追加）、まつたけ、もも、やまいも、りんご、ゼラチン",
