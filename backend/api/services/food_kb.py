...
FOOD_DB = {
    ...
    "dietary_restrictions": {
        "_meta": {
            ...
            "valid_until": None,
            "version": "1.0.1",
            "changelog": ["2026-05-10: Initial verified entry", "2026-05-11: アレルギー表示義務8品目に修正（くるみ2025年義務化）"]
        },
        "name_ja": "アレルギー・食制限",
        ...
        "allergy_labeling": {
            "mandatory_8": "表示義務8品目: 卵、乳、小麦、そば、落花生、えび、かに、くるみ（2025年義務化）",
            "recommended_20": "表示推奨20品目: アーモンド、あわび、いか、いくら、オレンジ、カシューナッツ、キウイ、牛肉、ごま、さけ、さば、大豆、鶏肉、バナナ、豚肉、まつたけ、もも、やまいも、りんご、ゼラチン",
